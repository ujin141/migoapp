...
const FindAccountPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      >
        <p className="text-2xl font-bold text-foreground mb-6">{t("findAccount.title")}</p>
            ...
            >
              <div className="flex items-start gap-2 p-3 rounded-2xl bg-blue-500/5 border border-blue-500/20 mb-4">
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  가입 시 등록한 **이름**과 **휴대폰 번호(+인증)**가 일치해야 조회가 가능합니다.
                </p>
              </div>
              ...
              {!foundEmail ? (
                  ...
                  {otpSent && !otpVerified && (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <span className="text-xs font-bold text-foreground">{t("findAccount.otpLabel")}</span>
                ...
                >
                  ...
                  <p className="text-sm font-bold text-muted-foreground mb-1">{t("findAccount.foundIdLabel")}</p>
              ...
              {!resetEmailSent ? (
                <>
                  <div className="flex items-start gap-2 p-3 rounded-2xl bg-blue-500/5 border border-blue-500/20 mb-4">
                    <AlertCircle size={14} className="text-blue-500 shrink-0 mt-0.5" />
                    <p className="text-xs text-muted-foreground leading-relaxed">
                      가입 시 등록하신 이메일 주소를 입력해 주시면 **비밀번호 재설정 링크**가 포함된 메일을 발송해 드립니다.
                    </p>
                  </div>
                ...
                >
                  ...
                  <p className="text-lg font-bold text-foreground mb-2">{t("findAccount.resetDoneTitle")}</p>
