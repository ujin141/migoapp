  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      >
        {!done ? (
          <>
            <p className="text-2xl font-bold text-foreground mb-2">{t("resetPassword.setNew")}</p>
            <p className="text-sm text-muted-foreground mb-8">{t("resetPassword.descNew")}</p>
          ...
          >
            ...
            <p className="text-xl font-bold text-foreground mb-2">{t("resetPassword.doneTitle")}</p>
            <p className="text-sm text-muted-foreground">{t("resetPassword.descDone")}</p>
          </motion.div>
        )}
      </motion.div>
    </div>
