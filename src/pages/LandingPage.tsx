    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col font-sans overflow-y-auto">
      ...
      <main className="flex-1 flex flex-col">
        ...
        <section className="relative px-6 py-20 flex flex-col items-center text-center overflow-hidden">
          ...
          >
            <span className="px-3 py-1 text-[10px] font-bold uppercase tracking-wider bg-primary/10 text-primary rounded-full mb-6 inline-block">
        ...
        <section className="px-6 py-16 bg-muted/30">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-extrabold text-center mb-12">{t('landing.featuresTitle', 'Core Features')}</h2>
      ...
      <footer className="border-t border-border bg-card px-6 py-8 mt-auto">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-2 opacity-80">
            ...
            <span className="font-bold text-sm text-muted-foreground">© {new Date().getFullYear()} MIGO. {t('landing.allRights', 'All rights reserved.')}</span>
          </div>
