  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="px-5 pt-12 pb-4 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-extrabold text-foreground">{t('notification.title')}</h1>
          {unreadCount > 0 && (
            <p className="text-sm text-muted-foreground mt-0.5">{t("notif.unreadCount", {count: unreadCount})}</p>
          )}
        </div>
        {unreadCount > 0 && (
          <button
        ...
        <div className="px-5 mb-5">
          ...
          >
            <div className="relative z-10 flex items-center gap-3">
              ...
              <div>
                <p className="text-white font-extrabold text-sm">{t("notif.viewCount", {count: profileViewCount})}</p>
      ...
      <div className="px-5 space-y-2">
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm text-foreground leading-snug">
                    <span className="font-bold">{["profile_view", "like", "superlike"].includes(n.type) && !isPlus ? t("notif.someone") : n.actor}</span>
                    {notifMessage(n)}
                  </p>
        ...
        {notifs.length === 0 && (
          <div className="text-center py-20">
            ...
            <p className="text-sm font-semibold text-foreground">{t('notification.empty')}</p>
