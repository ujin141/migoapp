...
export const AdminRevenue = () => {
  ...
  const statCards = [{
    label: t("auto.z_\uCD1D\uC218\uC775_933", "\uCD1D\uC218\uC775"),
    value: `₩${stats.total.toLocaleString()}`,
    icon: DollarSign,
    gradient: "from-emerald-500 to-teal-600"
  }, {
    label: t("auto.z_\uC774\uBC88\uB2EC\uC218\uC775_934", "\uC774\uBC88\uB2EC\uC218\uC775"),
    value: `₩${stats.monthly.toLocaleString()}`,
    icon: TrendingUp,
    gradient: "from-blue-500 to-cyan-500"
  }, {
    label: t("auto.z_\uD65C\uC131\uAD6C\uB3C5\uC790_935", "\uD65C\uC131\uAD6C\uB3C5\uC790"),
    value: stats.subs,
    icon: Crown,
    gradient: "from-violet-500 to-purple-600"
  }, {
    label: t("auto.z_\uCD1D\uAD6C\uB9E4\uAC74\uC218_936", "\uCD1D\uAD6C\uB9E4\uAC74\uC218"),
    value: stats.purchases,
    icon: ShoppingBag,
    gradient: "from-pink-500 to-rose-500"
  }, {
    label: t("auto.z_\uC774\uD0C8\uB960Churn_937", "\uC774\uD0C8\uB960Churn"),
  ...
  return <div className="space-y-6 truncate">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-extrabold text-foreground flex items-center gap-2 truncate">
            <DollarSign size={24} className="text-primary" />{t("auto.z_\uC218\uC775\uAD00\uB9AC_938", "\uC218\uC775\uAD00\uB9AC")}</h1>
          <p className="text-sm text-muted-foreground mt-1 truncate">{t("auto.z_\uAD6C\uB3C5\uD604\uD669\uC778\uC571\uAD6C\uB9E4\uB0B4\uC5ED_939", "\uAD6C\uB3C5\uD604\uD669\uC778\uC571\uAD6C\uB9E4\uB0B4\uC5ED")}</p>
        </div>
        <motion.button whileTap={{
        scale: 0.95
      }} onClick={load} className="flex items-center gap-2 px-3 py-2 rounded-xl bg-muted text-muted-foreground text-sm">
          <RefreshCw size={14} className={loading ? "animate-spin" : ""} />{t("auto.z_\uC0C8\uB85C\uACE0\uCE68_940", "\uC0C8\uB85C\uACE0\uCE68")}</motion.button>
      </div>
      ...
      {chartData.length > 0 && <div className="bg-card rounded-2xl border border-border p-5">
          <p className="text-sm font-bold text-foreground mb-4 truncate">{t("auto.z_\uC6D4\uBCC4\uC218\uC775\uCD94\uC774_941", "\uC6D4\uBCC4\uC218\uC775\uCD94\uC774")}</p>
          <ResponsiveContainer width="100%" height={180}>
            ...
            borderRadius: 12,
            fontSize: 12
          }} formatter={(v: any) => [`₩${Number(v).toLocaleString()}`, i18n.t("auto.z_\uC218\uC775_942", "\uC218\uC775")]} />
      ...
      {/* Subscriptions */}
      {tab === "subscriptions" && <div className="bg-card rounded-2xl border border-border overflow-hidden truncate">
          {loading ? <div className="p-12 text-center text-muted-foreground text-sm truncate">{t("auto.z_\uBD88\uB7EC\uC624\uB294\uC911_946", "\uBD88\uB7EC\uC624\uB294\uC911")}</div> : subscriptions.length === 0 ? <div className="p-12 text-center text-muted-foreground text-sm truncate">{t("auto.z_\uAD6C\uB3C5\uB370\uC774\uD130\uAC00\uC5C6\uC2B5\uB2C8\uB2E4_947", "\uAD6C\uB3C5\uB370\uC774\uD130\uAC00\uC5C6\uC2B5\uB2C8\uB2E4")}</div> : <div className="overflow-x-auto">
              <table className="w-full text-left">
                <thead className="bg-muted/50 border-b border-border">
                  <tr>
                    {[t("auto.z_\uC720\uC800_948", "\uC720\uC800"), t("auto.z_\uD50C\uB79C_949", "\uD50C\uB79C"), t("auto.z_\uAE08\uC561_950", "\uAE08\uC561"), t("auto.z_\uC0C1\uD0DC_951", "\uC0C1\uD0DC"), t("auto.z_\uC2DC\uC791\uC77C_952", "\uC2DC\uC791\uC77C")].map(h => <th key={h} className="p-4 text-xs font-bold text-muted-foreground">{h}</th>)}
                  </tr>
                </thead>
      ...
      {/* Purchases */}
      {tab === "purchases" && <div className="bg-card rounded-2xl border border-border overflow-hidden truncate">
          {loading ? <div className="p-12 text-center text-muted-foreground text-sm truncate">{t("auto.z_\uBD88\uB7EC\uC624\uB294\uC911_953", "\uBD88\uB7EC\uC624\uB294\uC911")}</div> : purchases.length === 0 ? <div className="p-12 text-center text-muted-foreground text-sm truncate">{t("auto.z_\uAD6C\uB9E4\uB0B4\uC5ED\uC774\uC5C6\uC2B5\uB2C8\uB2E4_954", "\uAD6C\uB9E4\uB0B4\uC5ED\uC774\uC5C6\uC2B5\uB2C8\uB2E4")}</div> : <div className="overflow-x-auto">
              <table className="w-full text-left">
                <thead className="bg-muted/50 border-b border-border">
                  <tr>
                    {[t("auto.z_\uC720\uC800_955", "\uC720\uC800"), t("auto.z_\uC544\uC774\uD15C\uC720\uD615_956", "\uC544\uC774\uD15C\uC720\uD615"), t("auto.z_\uAE08\uC561_957", "\uAE08\uC561"), t("auto.z_\uACB0\uC81C\uC77C_958", "\uACB0\uC81C\uC77C")].map(h => <th key={h} className="p-4 text-xs font-bold text-muted-foreground">{h}</th>)}
                  </tr>
                </thead>
                <tbody className="divide-y divide-border">
                  {purchases.map(p => <tr key={p.id} className="hover:bg-muted/30 transition-colors">
                      ...
                      <td className="p-4">
                        <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-blue-500/10 text-blue-400 truncate">
      ...
      {tab === "overview" && !loading && <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-card rounded-2xl border border-border p-5 truncate">
            <p className="text-sm font-bold text-foreground mb-3 truncate">{t("auto.z_\uAD6C\uB3C5\uD50C\uB79C\uBD84\uD3EC_960", "\uAD6C\uB3C5\uD50C\uB79C\uBD84\uD3EC")}</p>
          ...
          <div className="bg-card rounded-2xl border border-border p-5 truncate">
            <p className="text-sm font-bold text-foreground mb-3 truncate">{t("auto.z_\uC778\uC571\uAD6C\uB9E4\uC720\uD615\uBD84\uD3EC_961", "\uC778\uC571\uAD6C\uB9E4\uC720\uD615\uBD84\uD3EC")}</p>
