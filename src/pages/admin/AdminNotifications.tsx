...
const typeOptions: {
  ...
  value: "info",
  label: i18n.t("auto.z_\uC77C\uBC18\uC548\uB0B4_962", "\uC77C\uBC18\uC548\uB0B4"),
  color: "bg-blue-500/10 text-blue-400"
}, {
  value: "warning",
  label: i18n.t("auto.z_\uACBD\uACE0_963", "\uACBD\uACE0"),
  color: "bg-amber-500/10 text-amber-400"
}, {
  value: "update",
  label: i18n.t("auto.z_\uC5C5\uB370\uC774\uD2B8_964", "\uC5C5\uB370\uC774\uD2B8"),
  color: "bg-emerald-500/10 text-emerald-400"
}, {
  value: "promo",
  label: i18n.t("auto.z_\uD504\uB85C\uBAA8\uC158_965", "\uD504\uB85C\uBAA8\uC158"),
  color: "bg-violet-500/10 text-violet-400"
}, {
  value: "system",
  label: i18n.t("auto.z_\uC2DC\uC2A4\uD15C_966", "\uC2DC\uC2A4\uD15C"),
...
const targetOptions: {
  ...
  value: "all",
  label: i18n.t("auto.z_\uC804\uCCB4\uC720\uC800_967", "\uC804\uCCB4\uC720\uC800"),
  icon: Users
}, {
  value: "plus",
  label: i18n.t("auto.z_MIGOPlus\uC720\uC800_968", "MIGOPlus\uC720\uC800"),
  icon: Crown
}, {
  value: "verified",
  label: i18n.t("auto.z_\uC778\uC99D\uC720\uC800_969", "\uC778\uC99D\uC720\uC800"),
  icon: Check
}, {
  value: "free",
  label: i18n.t("auto.z_\uBB34\uB8CC\uC720\uC800_970", "\uBB34\uB8CC\uC720\uC800"),
  icon: Star
}];
const history: {
  title: string;
  ...
  return <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-card rounded-2xl border border-border p-6 space-y-4">
          <div>
            <label className="text-xs font-bold text-muted-foreground mb-1.5 block">{t("auto.z_\uB300\uC0C1\uC120\uD0DD_973", "\uB300\uC0C1\uC120\uD0DD")}</label>
          ...
          <div>
            <label className="text-xs font-bold text-muted-foreground mb-1.5 block">{t("auto.z_\uC54C\uB9BC\uC720\uD615_974", "\uC54C\uB9BC\uC720\uD615")}</label>
          ...
          <div>
            <label className="text-xs font-bold text-muted-foreground mb-1.5 block">{t("auto.z_\uB0B4\uC6A9_977", "\uB0B4\uC6A9")}</label>
            <textarea value={content} onChange={e => setContent(e.target.value)} rows={4} maxLength={200} placeholder={t("auto.z_\uC608\uC9C0\uAE08MIGO\uC5D0\uC11C\uC288_978", "\uC608\uC9C0\uAE08MIGO\uC5D0\uC11C\uC288")} className="w-full px-3 py-2.5 rounded-xl bg-muted border border-border text-sm text-foreground outline-none focus:border-primary resize-none" />
          ...
          <AnimatePresence>
            ...
            opacity: 0
                ...
                <Check size={16} /> {sent.count}{t("auto.z_\uBA85\uC5D0\uAC8C\uBC1C\uC1A1\uC644\uB8CC_979", "\uBA85\uC5D0\uAC8C\uBC1C\uC1A1\uC644\uB8CC")}</motion.div> : <motion.button whileTap={{
            scale: 0.97
                ...
                {sending ? <><div className="w-4 h-4 border-2 border-white/40 border-t-white rounded-full animate-spin" />{t("auto.z_\uBC1C\uC1A1\uC911_980", "\uBC1C\uC1A1\uC911")}</> : <><Send size={14} />{t("auto.z_\uC54C\uB9BC\uBC1C\uC1A1_981", "\uC54C\uB9BC\uBC1C\uC1A1")}</>}
              </motion.button>}
          </AnimatePresence>
        </div>
        ...
        <div className="space-y-4 truncate">
          ...
          {(title || content) && <div className="bg-card rounded-2xl border border-border p-5">
              <p className="text-[10px] font-bold text-muted-foreground mb-3 uppercase tracking-wide truncate">{t("auto.z_\uBBF8\uB9AC\uBCF4\uAE30_982", "\uBBF8\uB9AC\uBCF4\uAE30")}</p>
              <div className="flex items-start gap-3 p-3 rounded-xl bg-muted/50">
                <div className="w-9 h-9 rounded-xl bg-primary flex items-center justify-center shrink-0">
                  <Bell size={16} className="text-white" />
                </div>
                <div>
                  <p className="text-sm font-bold text-foreground truncate">{title || t("auto.z_\uC81C\uBAA9_983", "\uC81C\uBAA9")}</p>
                  <p className="text-xs text-muted-foreground mt-0.5 truncate">{content || t("auto.z_\uB0B4\uC6A9_984", "\uB0B4\uC6A9")}</p>
                </div>
              </div>
            </div>}
          ...
          <div className="bg-card rounded-2xl border border-border p-5 truncate">
            <p className="text-sm font-bold text-foreground mb-3 truncate">{t("auto.z_\uBC1C\uC1A1\uAE30\uB85D\uC138\uC158_985", "\uBC1C\uC1A1\uAE30\uB85D\uC138\uC158")}</p>
            {log.length === 0 ? <p className="text-xs text-muted-foreground text-center py-8 truncate">{t("auto.z_\uBC1C\uC1A1\uAE30\uB85D\uC774\uC5C6\uC2B5\uB2C8\uB2E4_986", "\uBC1C\uC1A1\uAE30\uB85D\uC774\uC5C6\uC2B5\uB2C8\uB2E4")}</p> : <div className="space-y-2 truncate">
                {log.map((l, i) => <div key={i} className="flex items-start gap-3 p-3 rounded-xl bg-muted/50">
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[10px] text-muted-foreground truncate">{l.target} · {l.type} · {l.sent}{i18n.t("auto.z_\uBA85\uBC1C\uC1A1_987", "\uBA85\uBC1C\uC1A1")}</p>
                    </div>
