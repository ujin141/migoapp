...
export const AdminDashboard = () => {
  ...
  const load = async () => {
    ...
    try {
      ...
      setLiveChartData(weekly.length ? weekly : Array.from({
        ...
        day: i18n.t("auto.z_tmpl_878", {
          defaultValue: i18n.t("auto.z_tmpl_1217", {
            defaultValue: t("auto.p1", {
              val: i + 1
            })
          })
        }),
  ...
  return <div>
      ...
      <div className="mb-6">
        <h2 className="text-sm font-extrabold text-muted-foreground uppercase tracking-wide mb-3">{t("admin.todayStatus")}</h2>
