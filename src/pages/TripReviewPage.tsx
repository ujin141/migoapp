...
const RATING_LABELS: Record<number, { label: string; color: string; emoji: string }> = {
  1: { label: i18n.t("auto.x4191"), color: "text-rose-500", emoji: "😞" },
  2: { label: i18n.t("auto.x4192"), color: "text-orange-500", emoji: "😕" },
  3: { label: i18n.t("auto.x4193"), color: "text-amber-500", emoji: "😐" },
  4: { label: i18n.t("auto.x4194"), color: "text-emerald-500", emoji: "😊" },
  5: { label: i18n.t("auto.x4195"), color: "text-primary", emoji: "🤩" },
};
  ...
  if (step === "done") {
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center p-8 text-center">
        ...
        >
          <h2 className="text-2xl font-extrabold mb-2 truncate">{t("auto.x4161")}</h2>
          ...
          <p className="text-xs text-muted-foreground mb-8 truncate">
            {t("auto.x4163")}
          </p>
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <header className="flex items-center gap-3 px-4 py-3 border-b border-border">
        ...
        <div>
          <h1 className="text-base font-extrabold truncate">{t("auto.x4166")}</h1>
          <p className="text-xs text-muted-foreground">{destination}</p>
        </div>
      </header>

      {/* Progress */}
      <div className="flex gap-1 px-4 pt-3 truncate">
        ...
        <AnimatePresence mode="wait">
          ...
          {step === "rating" && (
            ...
            >
              ...
              <div>
                <h2 className="text-xl font-extrabold mb-1 truncate">
          ...
          {step === "tags" && (
            ...
            >
              <div className="text-center">
                <h2 className="text-xl font-extrabold mb-1 truncate">{t("auto.p32")} {rating >= 3 ? t("auto.p33") : t("auto.p34")}</h2>
                <p className="text-xs text-muted-foreground truncate">{t("auto.x4169")}</p>
              </div>
          ...
          {step === "comment" && (
            ...
            >
              <div className="text-center">
                <h2 className="text-xl font-extrabold mb-1 truncate">{t("auto.x4172")}</h2>
                <p className="text-xs text-muted-foreground truncate">{t("auto.x4173")}</p>
              </div>
