...
const DIMENSIONS = [{
  key: "spontaneous",
  label: i18n.t("auto.g_0257", "즉흥적"),
  emoji: "⚡",
  labelA: i18n.t("auto.g_0258", "즉흥"),
  labelB: i18n.t("auto.g_0259", "계획"),
  color: "#f59e0b"
}, {
  key: "active",
  label: i18n.t("auto.g_0260", "활동적"),
  emoji: "🏃",
  labelA: i18n.t("auto.g_0261", "액티브"),
  labelB: i18n.t("auto.g_0262", "여유"),
  color: "#10b981"
}, {
  key: "earlyBird",
  label: i18n.t("auto.g_0263", "아침형"),
  emoji: "🌅",
  labelA: i18n.t("auto.g_0264", "아침형"),
  labelB: i18n.t("auto.g_0265", "야행성"),
  color: "#8b5cf6"
}, {
  key: "budget",
  label: i18n.t("auto.g_0266", "경험중시"),
  emoji: "💰",
  labelA: i18n.t("auto.g_0267", "경험중심"),
  labelB: i18n.t("auto.g_0268", "절약형"),
  color: "#3b82f6"
}, {
  key: "social",
  label: i18n.t("auto.g_0269", "활발함"),
  emoji: "👥",
  labelA: i18n.t("auto.g_0270", "함께"),
  labelB: i18n.t("auto.g_0271", "혼자"),
  color: "#ec4899"
}];
const TravelDNA = ({
  profile,
  ...
  if (compact) {
    ...
    return <div className="space-y-1 truncate">
        ...
        <div className="flex items-center gap-1.5 mb-1.5">
          ...
          <span className="ml-auto text-[11px] font-extrabold truncate" style={{
          color: overallMatch >= 80 ? "#10b981" : overallMatch >= 60 ? "#f59e0b" : "#ef4444"
        }}>
            {overallMatch}{i18n.t("auto.g_0273", "매칭")}</span>
        </div>
    ...
    return <div className="rounded-2xl p-4 border border-white/10 bg-white/5 relative overflow-hidden group">
      <div className="flex items-center justify-between mb-3 blur-sm opacity-50 select-none">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-xs font-extrabold text-foreground truncate">{i18n.t("auto.g_0274", "여행DNA")}</span>
        </div>
        <div className="flex items-center gap-1 px-2.5 py-1 rounded-full bg-emerald-500/15 text-emerald-500">
          <span className="text-xs font-extrabold truncate">--{i18n.t("auto.g_0275", "일치")}</span>
        </div>
      </div>
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center p-4 rounded-2xl bg-black/20">
        <div className="bg-background/95 backdrop-blur-md px-6 py-4 rounded-2xl shadow-xl flex flex-col items-center gap-3 border border-border mt-2">
           ...
           <p className="text-sm font-bold text-foreground text-center truncate">{i18n.t("auto.z_Plus\uACB0\uC81C\uC2DC_1195", "Plus\uACB0\uC81C\uC2DC")}<br />{i18n.t("auto.z_5\uCC28\uC6D0\uC5EC\uD589DNA\uBD84\uC11D_1196", "5\uCC28\uC6D0\uC5EC\uD589DNA\uBD84\uC11D")}</p>
        </div>
      </div>
    </div>;
  }
  return <div className="rounded-2xl p-4 border border-white/10 bg-white/5 truncate">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-1.5">
          <span className="text-sm">🧬</span>
          <span className="text-xs font-extrabold text-foreground truncate">{i18n.t("auto.g_0276", "여행DNA")}</span>
        </div>
        ...
        color: overallMatch >= 80 ? "#10b981" : overallMatch >= 60 ? "#f59e0b" : "#ef4444"
          ...
          <span className="text-xs font-extrabold truncate">{overallMatch}{i18n.t("auto.g_0277", "일치")}</span>
        </div>
      </div>
