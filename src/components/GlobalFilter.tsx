...
const getPopularDestinations = (t: any) => [{
  emoji: "🗾",
  city: i18n.t("gf.c_tokyo"),
  label_city: i18n.t("gf.c_tokyo"),
  country: i18n.t("auto.g_0000", "일본"),
  label_country: i18n.t("gf.n_jp")
}, {
  emoji: "🇰🇷",
  city: i18n.t("gf.c_seoul"),
  label_city: i18n.t("gf.c_seoul"),
  country: i18n.t("auto.g_0001", "한국"),
  label_country: i18n.t("gf.n_kr")
}, {
  emoji: "🇹🇭",
  city: i18n.t("gf.c_bangkok"),
  label_city: i18n.t("gf.c_bangkok"),
  country: i18n.t("auto.g_0002", "태국"),
  label_country: i18n.t("gf.n_th")
}, {
  emoji: "🌴",
  city: i18n.t("gf.c_bali"),
  label_city: i18n.t("gf.c_bali"),
  country: i18n.t("auto.g_0003", "인도네시아"),
  label_country: i18n.t("gf.n_id")
}, {
  emoji: "🇻🇳",
  city: i18n.t("gf.c_danang"),
  label_city: i18n.t("gf.c_danang"),
  country: i18n.t("auto.g_0004", "베트남"),
  label_country: i18n.t("gf.n_vn")
}, {
  emoji: "🇸🇬",
  city: i18n.t("gf.c_sg"),
  label_city: i18n.t("gf.c_sg"),
  country: i18n.t("auto.g_0005", "싱가포르"),
  label_country: i18n.t("gf.n_sg")
}, {
  emoji: "🏯",
  city: i18n.t("gf.c_osaka"),
  label_city: i18n.t("gf.c_osaka"),
  country: i18n.t("auto.g_0006", "일본"),
  label_country: i18n.t("gf.n_jp")
}, {
  emoji: "🇹🇼",
  city: i18n.t("gf.c_taipei"),
  label_city: i18n.t("gf.c_taipei"),
  country: i18n.t("auto.g_0007", "대만"),
  label_country: i18n.t("gf.n_tw")
}, {
  emoji: "🗺️",
  city: i18n.t("gf.c_chiangmai"),
  label_city: i18n.t("gf.c_chiangmai"),
  country: i18n.t("auto.g_0008", "태국"),
  label_country: i18n.t("gf.n_th")
}, {
  emoji: "🇵🇭",
  city: i18n.t("gf.c_cebu"),
  label_city: i18n.t("gf.c_cebu"),
  country: i18n.t("auto.g_0009", "필리핀"),
  label_country: i18n.t("gf.n_ph")
}, {
  emoji: "🇪🇸",
  city: i18n.t("gf.c_bcn"),
  label_city: i18n.t("gf.c_bcn"),
  country: i18n.t("auto.g_0010", "스페인"),
  label_country: i18n.t("gf.n_es")
}, {
  emoji: "🗼",
  city: i18n.t("gf.c_paris"),
  label_city: i18n.t("gf.c_paris"),
  country: i18n.t("auto.g_0011", "프랑스"),
  label_country: i18n.t("gf.n_fr")
}];
...
const getGroupSizes = (t: any) => [{
  value: 2,
  label: i18n.t("auto.z_2\uBA85_652fc6", "2\uBA85"),
  icon: "👫"
}, {
  value: 3,
  label: i18n.t("auto.z_3\uBA85_38c9b2", "3\uBA85"),
  icon: "👨‍👩‍👦"
}, {
  value: 4,
  label: i18n.t("auto.z_4\uBA85_8b11ed", "4\uBA85"),
  icon: "👨‍👩‍👧‍👦"
}, {
  value: 5,
  label: i18n.t("auto.z_5\uBA85_234305", "5\uBA85"),
  icon: "🧑‍🤝‍🧑"
}, {
  value: 6,
  label: i18n.t("auto.z_6\uBA85_0f6d08", "6\uBA85"),
  icon: "👥"
}];
...
// Date helpers
// ──────────────────────────────────────────────
const getWeekdays = (t: any) => [i18n.t("gf.w_sun"), i18n.t("gf.w_mon"), i18n.t("gf.w_tue"), i18n.t("gf.w_wed"), i18n.t("gf.w_thu"), i18n.t("gf.w_fri"), i18n.t("gf.w_sat")];
const getMonths = (t: any) => [i18n.t("gf.m_1"), i18n.t("gf.m_2"), i18n.t("gf.m_3"), i18n.t("gf.m_4"), i18n.t("gf.m_5"), i18n.t("gf.m_6"), i18n.t("gf.m_7"), i18n.t("gf.m_8"), i18n.t("gf.m_9"), i18n.t("gf.m_10"), i18n.t("gf.m_11"), i18n.t("gf.m_12")];
...
const getDatePresets = (t: any) => [{
  label: i18n.t("auto.z_\uC774\uBC88\uC8FC\uB9D0_4eb8f2", "\uC774\uBC88\uC8FC\uB9D0"),
  start: () => {
    const d = today();
  ...
  label: i18n.t("auto.z_\uB2E4\uC74C\uC8FC_415e52", "\uB2E4\uC74C\uC8FC"),
  start: () => {
    const d = today();
  ...
  label: i18n.t("auto.z_\uC774\uBC88\uB2EC_35cb7d", "\uC774\uBC88\uB2EC"),
  start: () => fmt(today()),
  end: () => {
    const d = today();
  ...
  label: i18n.t("auto.z_\uB2E4\uC74C\uB2EC_56cafa", "\uB2E4\uC74C\uB2EC"),
  start: () => {
    const d = today();
...
function CalendarMonth({
  ...
  return <div>
      ...
      <div className="grid grid-cols-7 gap-0.5 truncate">
        {cells.map((day, idx) => {
...
const GlobalFilter: React.FC<GlobalFilterProps> = ({
  ...
  const fmtKr = (d: string) => {
    ...
    if (lang.startsWith("ko") || lang.startsWith("ja") || lang.startsWith("zh")) {
      return t("auto.t_0000", `${parseInt(m)}${t("auto.z_\uC6D4_7c9d2f", { defaultValue: "월" })} ${parseInt(day)}${t("auto.z_\uC77C_5d2b7d", { defaultValue: "일" })}`);
    }
    return `${m}/${day}`;
  };
  ...
  return <AnimatePresence>
      {open && <>
        ...
        duration: 0.2
      }} onClick={onClose} className="fixed inset-0 z-[100] bg-black/40 backdrop-blur-sm pointer-events-auto" />
        ...
        overscrollBehavior: "contain"
            ...
            <div className="sticky top-7 z-10 bg-background flex items-center justify-between px-5 py-3 border-b border-border/50">
              <div>
                <h2 className="text-lg font-extrabold text-foreground tracking-tight truncate">{t("auto.z_\uC5EC\uD589\uD544\uD130_ef40d3", "\uC5EC\uD589\uD544\uD130")}</h2>
                <p className="text-xs text-muted-foreground mt-0.5 truncate">{t("auto.z_\uC6D0\uD558\uB294\uC5EC_063fc3", "\uC6D0\uD558\uB294\uC5EC")}</p>
              </div>
              <div className="flex items-center gap-2 truncate">
                {localActiveCount > 0 && <button onClick={handleReset} className="flex items-center gap-1 px-3 py-1.5 rounded-xl bg-muted text-xs font-semibold text-muted-foreground hover:text-foreground transition-all active:scale-95">
                    <RotateCcw size={11} />{t("auto.z_\uCD08\uAE30\uD654_2d7cf9", "\uCD08\uAE30\uD654")}</button>}
            ...
            <div className="px-5 py-5 space-y-6">
              ...
              <section>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-sm font-bold text-foreground truncate">{t("auto.z_\uC5EC\uD589\uC9C0_3d9769", "\uC5EC\uD589\uC9C0")}</span>
                ...
                {/* Search input */}
                <div className="relative mb-3 truncate">
                  <Search size={14} className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground" />
                  <input ref={inputRef} type="text" value={destSearch} onChange={e => handleSearchChange(e.target.value)} placeholder={t("auto.z_\uB3C4\uCFC4\uD30C\uB9AC_8a3f30", "\uB3C4\uCFC4\uD30C\uB9AC")} className="w-full bg-muted rounded-2xl pl-9 pr-9 py-3 text-sm text-foreground outline-none focus:ring-2 focus:ring-primary/30 placeholder:text-muted-foreground/60" />
                ...
                return <motion.button key={dest.city} whileTap={{
                  ...
                  {filteredPopular.length === 0 && <p className="text-xs text-muted-foreground py-2 truncate">"{destSearch}{t("auto.z_\uADF8\uB300\uB85C\uC801_fedcdd", "\uADF8\uB300\uB85C\uC801")}</p>}
                </div>
              </section>
              ...
              <section>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-sm font-bold text-foreground truncate">{t("auto.z_\uB0A0\uC9DC_a93b53", "\uB0A0\uC9DC")}</span>
                  {dateDisplay && <span className="ml-auto text-xs text-blue-500 font-semibold">{dateDisplay}</span>}
                </div>
                <div className="flex gap-2 flex-wrap mb-4 truncate">
                ...
                <div className="bg-muted/40 rounded-2xl p-4 border border-border">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-sm font-extrabold text-foreground truncate">{calYear}{t("auto.z_\uB144_e29d2c", "\uB144")}{months[calMonth]}</span>
              ...
              <section>
                <div className="flex items-center gap-2 mb-3 truncate">
                  ...
                  <span className="text-sm font-bold text-foreground truncate">{t("auto.z_\uC778\uC6D0\uC218_553bc2", "\uC778\uC6D0\uC218")}</span>
                  {localGroupSize !== null && <span className="ml-auto text-xs text-purple-500 font-semibold flex items-center gap-1 truncate">
                      <Check size={11} /> {localGroupSize === 6 ? t("gf.s_6_more") : t("auto.t_0001", `${localGroupSize}${t("auto.z_\uBA85_db7391", { defaultValue: "명" })}`)}
                    </span>}
                </div>
                ...
                scale: 0.95
                    ...
                    <span className={`text-xs font-bold ${localGroupSize === null ? "text-purple-600" : "text-muted-foreground"}`}>{t("auto.z_\uC804\uCCB4_d1d0de", "\uC804\uCCB4")}</span>
                  </motion.button>
                  {groupSizes.map(gs => {
            ...
            scale: 0.97
              ...
              skewX: -20
                ...
                <span className="relative z-10 flex items-center justify-center gap-2 truncate">
                  {localActiveCount > 0 ? <><Check size={18} strokeWidth={3} />{t("auto.z_\uD544\uD130\uC801\uC6A9_a0bd26", "\uD544\uD130\uC801\uC6A9")}{localActiveCount}{t("auto.z_\uAC1C_d22b87", "\uAC1C")}</> : t("gf.view_all")}
                </span>
              </motion.button>
            </div>
          </motion.div>
