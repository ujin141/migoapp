          ...
          <div className="px-5 pt-4 pb-20">
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg font-extrabold text-foreground truncate">{t("auto.g_0199", "나를확인한")}</h3>
              </div>
            ...
            <div className="space-y-4 truncate">
              {loading ? <p className="text-center text-muted-foreground py-10 truncate">{t("auto.g_0200", "불러오는중")}</p> : viewers.length === 0 ? <div className="text-center py-10 text-muted-foreground">
                  ...
                  <p className="font-semibold truncate">{t("profileViews.empty")}</p>
                </div> : <div className="grid grid-cols-2 gap-3 relative truncate">
                  ...
                  (e.target as HTMLImageElement).src = "https://via.placeholder.com/150?text=" + (v.name ? v.name[0] : "?");
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent flex flex-col justify-end p-3 truncate">
                        {isPlus ? <>
                        ...
                        day: "numeric"
                            ...
                            <span className="text-white font-bold text-xs truncate">{t("auto.g_0203", "누군가날봤")}</span>
                          </div>}
                      </div>
                    </div>)}
