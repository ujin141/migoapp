        ...
        stiffness: 260
            ...
            type: "spring"
              ...
              <p className="text-sm text-muted-foreground mt-1 truncate">
                <span className="font-bold text-primary">{matchedProfile.name}</span>{t("auto.z_\uB2D8\uACFC\uB9E4\uCE6D\uB418\uC5C8\uC5B4\uC694_1384", "\uB2D8\uACFC\uB9E4\uCE6D\uB418\uC5C8\uC5B4\uC694")}</p>
            </div>
            ...
            {common.length > 0 && <div className="bg-primary/5 rounded-2xl p-3 mb-4">
                <div className="flex items-center gap-1.5 mb-2">
                  ...
                  <p className="text-xs font-extrabold text-primary truncate">{t("auto.z_\uACF5\uD1B5\uC810\uBC1C\uACAC_1385", "\uACF5\uD1B5\uC810\uBC1C\uACAC")}</p>
                </div>
            ...
            <div className="bg-muted rounded-2xl p-3 mb-5">
              <p className="text-[10px] font-bold text-muted-foreground mb-1 truncate">{t("auto.z_\uB300\uD654\uC2DC\uC791\uCD94\uCC9C\uC9C8\uBB38_1386", "\uB300\uD654\uC2DC\uC791\uCD94\uCC9C\uC9C8\uBB38")}</p>
              <p className="text-xs text-foreground font-medium">"{ice}"</p>
            </div>

            {/* 버튼 */}
            <div className="flex gap-2">
              <button onClick={onClose} className="flex-1 py-3 rounded-2xl bg-muted text-muted-foreground text-sm font-bold">{t("auto.z_\uB098\uC911\uC5D0_1387", "\uB098\uC911\uC5D0")}</button>
            ...
            scale: 0.97
                ...
                <MessageCircle size={16} />{t("auto.z_\uC9C0\uAE08\uB300\uD654\uD558\uAE30_1388", "\uC9C0\uAE08\uB300\uD654\uD558\uAE30")}</motion.button>
            </div>
          </motion.div>
        </motion.div>}
    </AnimatePresence>;
