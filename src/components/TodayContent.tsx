...
const TIPS = [{
  icon: "🎒",
  text: i18n.t("auto.z_\uC9D0\uC740\uB3CC\uB3CC\uB9D0\uC544\uB123\uC73C\uBA743_1200"),
  city: i18n.t("auto.z_\uB3C4\uCFC4_1201"),
  flag: "🇯🇵",
  color: "from-pink-500 to-rose-500"
}, {
  icon: "💳",
  text: i18n.t("auto.z_\uD2B8\uB798\uBE14\uCCB4\uD06C\uCE74\uB4DC\uB85CAT_1202"),
  city: i18n.t("auto.z_\uBC29\uCF55_1203"),
  flag: "🇹🇭",
  color: "from-amber-500 to-orange-500"
}, {
  icon: "☁️",
  text: i18n.t("auto.z_\uD56D\uACF5\uAD8C\uC740\uD654\uC218\uC694\uC77C\uC0C8\uBCBD_1204"),
  city: i18n.t("auto.z_\uBC14\uB974\uC140\uB85C\uB098_1205"),
  flag: "🇪🇸",
  color: "from-blue-500 to-indigo-600"
}, {
  icon: "🌐",
  text: i18n.t("auto.z_\uAD6C\uAE00\uBC88\uC5ED\uCE74\uBA54\uB77C\uB85C\uBA54\uB274_1206"),
  city: i18n.t("auto.z_\uB274\uC695_1207"),
  flag: "🇺🇸",
  color: "from-slate-500 to-gray-700"
}, {
  icon: "🔌",
  text: i18n.t("auto.z_\uC720\uB7FD\uC5EC\uD589\uC5D4\uBA40\uD2F0\uC5B4\uB311\uD130_1208"),
  city: i18n.t("auto.z_\uBC1C\uB9AC_1209"),
  flag: "🇮🇩",
  color: "from-emerald-500 to-teal-500"
}, {
  icon: "📱",
  text: i18n.t("auto.z_Migo\uC5D0\uC11C\uD604\uC9C0\uC5EC\uD589_1210"),
  city: i18n.t("auto.z_\uD30C\uB9AC_1211"),
  flag: "🇫🇷",
  color: "from-violet-500 to-purple-600"
}, {
  icon: "🗺️",
  text: i18n.t("auto.z_\uC624\uD504\uB77C\uC778\uC9C0\uB3C4\uBBF8\uB9AC\uB2E4\uC6B4_1212"),
  city: i18n.t("auto.z_\uC2F1\uAC00\uD3EC\uB974_1213"),
  flag: "🇸🇬",
  color: "from-sky-500 to-blue-600"
}, {
  icon: "🏥",
  text: i18n.t("auto.z_\uC5EC\uD589\uC790\uBCF4\uD5D8\uCD9C\uBC1C\uC804\uB0A0\uAE4C_1214"),
  city: i18n.t("auto.z_\uC774\uC2A4\uD0C4\uBD88_1215"),
  flag: "🇹🇷",
  ...
  return <div className="px-4 pb-2">
      ...
      scale: 0.98
        ...
        <div className="shrink-0 flex items-center gap-1.5">
          <span className="text-[10px] font-bold text-primary">🔥 {todayTravelers}{t("auto.z_\uBA85_1216")}</span>
      ...
      <AnimatePresence>
        ...
        duration: 0.2
            ...
            value: t("auto.z_tmpl_1218", {
              defaultValue: `${todayTravelers} people`
            }),
            icon: "👤"
          }, {
            label: t("auto.z_\uD65C\uC131\uADF8\uB8F9_1219"),
            value: t("auto.z_tmpl_1220", {
              defaultValue: `${40 + new Date().getDate() * 13 % 60} groups`
            }),
            icon: "👥"
          }, {
            label: t("auto.z_\uC624\uB298\uB9E4\uCE58_1221"),
            value: t("auto.z_tmpl_1222", {
              defaultValue: `${100 + new Date().getDate() * 29 % 150} matches`
            }),
            icon: "💫"
