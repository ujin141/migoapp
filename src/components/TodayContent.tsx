...
export default function TodayContent() {
  ...
  const TIPS = [{
    icon: "🎒",
    text: t("auto.z_\uC9D0\uC740\uB3CC\uB3CC\uB9D0\uC544\uB123\uC73C\uBA743_1200", "\uC9D0\uC740\uB3CC\uB3CC\uB9D0\uC544\uB123\uC73C\uBA743"),
    city: t("auto.z_\uB3C4\uCFC4_1201", "\uB3C4\uCFC4"),
    flag: "🇯🇵",
    color: "from-pink-500 to-rose-500"
  }, {
    icon: "💳",
    text: t("auto.z_\uD2B8\uB798\uBE14\uCCB4\uD06C\uCE74\uB4DC\uB85CAT_1202", "\uD2B8\uB798\uBE14\uCCB4\uD06C\uCE74\uB4DC\uB85CAT"),
    city: t("auto.z_\uBC29\uCF55_1203", "\uBC29\uCF55"),
    flag: "🇹🇭",
    color: "from-amber-500 to-orange-500"
  }, {
    icon: "☁️",
    text: t("auto.z_\uD56D\uACF5\uAD8C\uC740\uD654\uC218\uC694\uC77C\uC0C8\uBCBD_1204", "\uD56D\uACF5\uAD8C\uC740\uD654\uC218\uC694\uC77C\uC0C8\uBCBD"),
    city: t("auto.z_\uBC14\uB974\uC140\uB85C\uB098_1205", "\uBC14\uB974\uC140\uB85C\uB098"),
    flag: "🇪🇸",
    color: "from-blue-500 to-indigo-600"
  }, {
    icon: "🌐",
    text: t("auto.z_\uAD6C\uAE00\uBC88\uC5ED\uCE74\uBA54\uB77C\uB85C\uBA54\uB274_1206", "\uAD6C\uAE00\uBC88\uC5ED\uCE74\uBA54\uB77C\uB85C\uBA54\uB274"),
    city: t("auto.z_\uB274\uC695_1207", "\uB274\uC695"),
    flag: "🇺🇸",
    color: "from-slate-500 to-gray-700"
  }, {
    icon: "🔌",
    text: t("auto.z_\uC720\uB7FD\uC5EC\uD589\uC5D4\uBA40\uD2F0\uC5B4\uB311\uD130_1208", "\uC720\uB7FD\uC5EC\uD589\uC5D4\uBA40\uD2F0\uC5B4\uB311\uD130"),
    city: t("auto.z_\uBC1C\uB9AC_1209", "\uBC1C\uB9AC"),
    flag: "🇮🇩",
    color: "from-emerald-500 to-teal-500"
  }, {
    icon: "📱",
    text: t("auto.z_Migo\uC5D0\uC11C\uD604\uC9C0\uC5EC\uD589_1210", "Migo\uC5D0\uC11C\uD604\uC9C0\uC5EC\uD589"),
    city: t("auto.z_\uD30C\uB9AC_1211", "\uD30C\uB9AC"),
    flag: "🇫🇷",
    color: "from-violet-500 to-purple-600"
  }, {
    icon: "🗺️",
    text: t("auto.z_\uC624\uD504\uB77C\uC778\uC9C0\uB3C4\uBBF8\uB9AC\uB2E4\uC6B4_1212", "\uC624\uD504\uB77C\uC778\uC9C0\uB3C4\uBBF8\uB9AC\uB2E4\uC6B4"),
    city: t("auto.z_\uC2F1\uAC00\uD3EC\uB974_1213", "\uC2F1\uAC00\uD3EC\uB974"),
    flag: "🇸🇬",
    color: "from-sky-500 to-blue-600"
  }, {
    icon: "🏥",
    text: t("auto.z_\uC5EC\uD589\uC790\uBCF4\uD5D8\uCD9C\uBC1C\uC804\uB0A0\uAE4C_1214", "\uC5EC\uD589\uC790\uBCF4\uD5D8\uCD9C\uBC1C\uC804\uB0A0\uAE4C"),
    city: t("auto.z_\uC774\uC2A4\uD0C4\uBD88_1215", "\uC774\uC2A4\uD0C4\uBD88"),
    flag: "🇹🇷",
  ...
  return <div className="px-4 pb-2">
      ...
      scale: 0.98
        ...
        <div className="shrink-0 flex items-center gap-1.5">
          <span className="text-[10px] font-bold text-primary truncate">🔥 {todayTravelers}{i18n.language === 'ko' ? t("auto.g_0236", "명") : ' persons'}</span>
      ...
      <AnimatePresence>
        ...
        duration: 0.2
            ...
            <div className="pt-2 grid grid-cols-3 gap-2 truncate">
              {[{
            label: t("auto.z_\uC624\uB298\uC5EC\uD589\uC790_1217", "\uC624\uB298\uC5EC\uD589\uC790"),
            value: t("auto.t_0012", `${todayTravelers}${i18n.language === 'ko' ? t("auto.g_0237", "명") : ' persons'}`),
            icon: "👤"
          }, {
            label: t("auto.z_\uD65C\uC131\uADF8\uB8F9_1219", "\uD65C\uC131\uADF8\uB8F9"),
            value: t("auto.t_0013", `${40 + new Date().getDate() * 13 % 60}${i18n.language === 'ko' ? t("auto.g_0238", "그룹") : ' groups'}`),
            icon: "👥"
          }, {
            label: t("auto.z_\uC624\uB298\uB9E4\uCE58_1221", "\uC624\uB298\uB9E4\uCE58"),
            value: t("auto.t_0014", `${100 + new Date().getDate() * 29 % 150}${i18n.language === 'ko' ? t("auto.g_0239", "매치") : ' matches'}`),
            icon: "💫"
