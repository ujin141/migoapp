            ...
            background: "linear-gradient(135deg, #f43f5e, #fb7185)"
              ...
              (e.target as HTMLImageElement).style.display = 'none';
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-extrabold text-rose-700 truncate">{notif.actorName}{t("auto.z_\uB2D8\uC774\uC88B\uC544\uC694\uB97C\uBCF4\uB0C8\uC5B4\uC694_1043")}</p>
                  <p className="text-xs text-rose-400 mt-0.5">{t("auto.z_\uB9E4\uCE6D\uB420\uC218\uB3C4\uC788\uC5B4\uC694_1044")}</p>
                </div>
          ...
          background: "linear-gradient(90deg, #3b82f6, #6366f1, #8b5cf6, #6366f1, #3b82f6)"
            ...
            repeat: Infinity
              ...
              boxShadow: "0 0 12px rgba(99,102,241,0.5)"
                ...
                {/* Text */}
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-extrabold text-white truncate">{notif.actorName}{t("auto.z_\uB2D8\uC758\uC288\uD37C\uB77C\uC774\uD06C_1045")}</p>
                  {notif.message ? <p className="text-xs text-indigo-300 mt-0.5 truncate">"{notif.message}"</p> : <p className="text-xs text-indigo-400 mt-0.5">{t("auto.z_\uC0C1\uB300\uBC29\uC774\uB2F9\uC2E0\uC744\uD2B9\uBCC4\uD788_1046")}</p>}
                </div>
