        ...
        stiffness: 300
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-2">
                ...
                <h2 className="font-bold text-lg">{t("checkin.title")}</h2>
              </div>
            ...
            {step === "idle" && <div className="space-y-4">
                <div className="bg-primary/5 rounded-2xl p-4 text-sm text-muted-foreground leading-relaxed">{t("checkin.desc1")}<span className="text-primary font-bold">{t("checkin.desc2")}</span>{t("checkin.desc3")}</div>
            ...
            {step === "locating" && <div className="flex flex-col items-center gap-4 py-8">
                ...
                <p className="text-sm text-muted-foreground">{t("checkin.locating")}</p>
              </div>}
            ...
            {step === "confirming" && <div className="space-y-5">
                ...
                <p className="text-sm text-muted-foreground text-center">{t("checkin.confirm_desc")}</p>
            ...
            {step === "done" && <div className="space-y-5">
                ...
                <div className="bg-gradient-to-br from-primary/20 to-purple-500/10 rounded-2xl p-5 flex flex-col items-center gap-2 text-center">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-extrabold text-lg text-primary">{t("checkin.done_badge")}</span>
                  </div>
                  ...
                  <div className="flex items-center gap-1 mt-2 bg-primary/10 rounded-full px-3 py-1">
                    ...
                    <span className="text-xs font-bold text-primary">{nearbyCount}{t("checkin.people_here")}</span>
                  </div>
                  <p className="text-xs text-muted-foreground mt-1">{expiresHours}{t("checkin.expires")}</p>
                </div>
